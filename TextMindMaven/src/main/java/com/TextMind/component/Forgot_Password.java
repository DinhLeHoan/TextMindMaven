...
//        forgotPass.add(btnSubmit, "w 40%, h 20");
	...
	private void initComponents() {
		...
		forgotPassLayout.setHorizontalGroup(forgotPassLayout
				...
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, forgotPassLayout.createSequentialGroup()
						...
						.addGap(108, 108, 108).addComponent(btnClose).addGap(30, 30, 30)));
		forgotPassLayout.setVerticalGroup(forgotPassLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(forgotPassLayout.createSequentialGroup().addGap(0, 0, 0)
						.addComponent(title2, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 170, Short.MAX_VALUE)
						.addGroup(forgotPassLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(btnSend).addComponent(btnClose))
						.addGap(21, 21, 21)));
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(Forgot_Password.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
