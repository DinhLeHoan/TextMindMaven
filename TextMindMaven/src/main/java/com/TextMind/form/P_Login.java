...
public class P_Login extends javax.swing.JPanel {
	...
	private Forgot_Password forgotPasswordDialog;
	...
	public Forgot_Password getForgotPasswordDialog() {
	...
	private void initLogin() {
		...
		forgot.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				forgotPasswordDialog = new Forgot_Password(Login.getFrames()[0], true);
	...
	private void initComponents() {
		...
		loginLayout.setVerticalGroup(loginLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(loginLayout.createSequentialGroup()
						.addComponent(lblError, javax.swing.GroupLayout.PREFERRED_SIZE, 51,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(33, 33, 33).addComponent(btnLogin)
