...
public class ProgressCircleUI extends BasicProgressBarUI {
	...
	public ProgressCircleUI(Progress pro) {
		this.pro = pro;
		imageDown = new ImageIcon(getClass().getResource("/images/down.png")).getImage();
		imageCancel = new ImageIcon(getClass().getResource("/images/cancel.png")).getImage();
		imageFile = new ImageIcon(getClass().getResource("/images/file.png")).getImage();
	}
	...
	public void paint(Graphics g, JComponent c) {
		...
		if (pro.getProgressType() != Progress.ProgressType.NONE) {
			g2.drawImage(
					pro.getProgressType() == Progress.ProgressType.CANCEL ? imageCancel
							: pro.getProgressType() == Progress.ProgressType.DOWN_FILE ? imageDown : imageFile,
